...
class uploaddocuments2CV extends StatefulWidget {
  const uploaddocuments2CV({Key? key}) : super(key: key);

  @override
  State<uploaddocuments2CV> createState() => _uploaddocuments2CVState();
}

class _uploaddocuments2CVState extends State<uploaddocuments2CV> {
                                ...
                                if (_formKey.currentState!.validate()) {
                                  if (Name.text == "CV") {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => UploadDocumentsCV(
