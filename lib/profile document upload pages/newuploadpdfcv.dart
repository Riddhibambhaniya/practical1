...
class newuploadpdfCV extends StatefulWidget {
  const newuploadpdfCV ({Key? key}) : super(key: key);

  @override
  State<newuploadpdfCV > createState() => _newuploadpdfCVState();
}

class _newuploadpdfCVState extends State<newuploadpdfCV > {
