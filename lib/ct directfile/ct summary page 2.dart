...
class CTsummary2 extends StatefulWidget {
  const CTsummary2({Key? key}) : super(key: key);

  @override
  State<CTsummary2> createState() => _CTsummary2State();
}

class _CTsummary2State extends State<CTsummary2> {
        ...
        body:  SafeArea(
          ...
          child: Column(children: [
            ...
            Padding(
              ...
              child: Text("Handler/ Trainer Comment",
                style: GoogleFonts.roboto(
